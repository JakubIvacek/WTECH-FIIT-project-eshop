    ...
    <div class="row justify-content-center align-items-center d-flex">
        <div class="col-3 mt-3">
            <a href="/" class="navbar-brand mt-3">
                <img class="rounded-4 smaller" src="img/iconsHomePage/icon.png" alt="logo image" height="85">
            </a>
        </div>
                ...
                <div class="container-fluid navSize">
                    <ul class="navbar-nav d-flex flex-row align-items-center">
                        ...
                        <li class="nav-item mr-8">
                            <a href="/products" class="nav-link customColor">
...
<!-- PRODUCT CLOSEUP -->
<section id="cardBody" class="justify-content-center">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <!-- Add to cart button -->
                            <button id="addToCartBtn" class="bg-warning btn btn-warning btn-lg fw-bold w-100" type="button">
                                <span class="biggerInput fw-bold">Add to cart</span>
                            </button>
                            <button type="button" class="btn btn-secondary bg-dark mobileBiggerSmall fw-bold" data-dismiss="modal">Back</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="row justify-content-evenly">
        <div class="col-6 ms-5 mt-5">
            ...
            <div class="row mt-3 mb-3">
                <div class="col">
                    <img src="img/iconsHomePage/pays.png" alt="icon payment methods" width="205">
                </div>
            </div>
...
<script src="js/own_js_product.js"></script>
