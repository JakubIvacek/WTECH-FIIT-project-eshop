...
<section>
    <div class="container-fluid">
        ...
        <div class="row justify-content-center ">
            <div class="border-dark height1000 col-12"  id="cardContainer">
        ...
        <div class="row pt-3 justify-content-center">
            <div class="col-2 text-end align-items-center">
                <button class="bg-transparent border-0" onclick="prevPage()">
                    <img src="img/prev_icon.jpg" alt="icon" width="35" class="pe-1 mb-2">
                    <span class="text-white h3">Back</span>
                </button>
            </div>
            <div class="col-2 text-start align-items-center">
                <button class="bg-transparent border-0" onclick="nextPage()">
                    <span class="text-white h3 pe-1">Next</span>
                    <img src="img/next_icon.jpg" alt="icon" width="32" class="mb-2">
                </button>
            </div>
        </div>
        <div class="row text-center">
            <h3 class="text-light" id="pageNum"></h3>
        </div>
    </div>
</section>
